...
spin_width = 40
spin_height = 20
spin_x = (age_x + name_width) + 10
spin_y = line1_y + line1_height + 10
...
class AppForm:
    ...
    def Widgets(self):
        ...
        self.spin = QSpinBox(self.dialog)
        ...
        # SpinBox
        self.spin.setGeometry(spin_x, spin_y, spin_width, spin_height)
        self.spin.setMinimum(18)
    ...
    def Events(self):
        if self.com.currentText() == 'Male'.upper():
            ...
            {self.line1.text()} Successfully Signed Up''')
